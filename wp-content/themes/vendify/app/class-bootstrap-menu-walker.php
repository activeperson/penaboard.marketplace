 ...
 *
 * Modified to fit Vendify class names.
 *
...
class Bootstrap_Menu_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
		...
		if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
			...
			$atts['class']         = 'sh-dropdown__toggle sh-dropdown__toggle-arrow nav-link';
			...
			if ( $depth > 0 ) {
				...
				$atts['class'] = 'nav-link nav-link--has-children';
			}
		}
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'edit_theme_options' ) ) {
			...
			$fallback_output .= '>';
			$fallback_output .= '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr__( 'Add a menu', 'vendify' ) . '">' . esc_html__( 'Add a menu', 'vendify' ) . '</a></li>';
			$fallback_output .= '</ul>';
			if ( $container ) {
				$fallback_output .= '</' . esc_attr( $container ) . '>';
			}
