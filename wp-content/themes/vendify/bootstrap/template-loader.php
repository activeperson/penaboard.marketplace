 ...
 *
 * Changes:
 *  `/wp-content/themes/vendify/single.php`
 * to:
 *  `/wp-content/themes/vendify/resources/views/single.php`
 *
 * For a child theme to override the file:
 *   `/wp-content/themes/vendify/resources/views/global/header.php`
 * create the file:
 *   `/wp-content/themes/vendify-child/global/header.php`
 *
 * or
 *
 *   `/wp-content/themes/vendify/resources/views/single.php`
 * create the file:
 *   `/wp-content/themes/vendify-child/single.php`
 *
 * @since 1.0.0
 *
 * @package Vendify
