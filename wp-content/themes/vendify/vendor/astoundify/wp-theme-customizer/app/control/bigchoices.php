...
class Astoundify_ThemeCustomizer_Control_BigChoices extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'astoundify-themecustomizer-bigchoices', esc_url( $install_url . '/assets/js/controls/BigChoices.js' ), array( 'jquery', 'astoundify-themecustomizer-select2', 'customize-controls' ) );
