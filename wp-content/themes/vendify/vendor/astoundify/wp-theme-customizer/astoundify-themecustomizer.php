...
define( 'ASTOUNDIFY_THEME_CUSTOMIZER_VERSION', '1.4.0' );
define( 'ASTOUNDIFY_THEME_CUSTOMIZER_FILE', __FILE__ );
define( 'ASTOUNDIFY_THEME_CUSTOMIZER_PLUGIN', plugin_basename( __FILE__ ) );
define( 'ASTOUNDIFY_THEME_CUSTOMIZER_PATH', trailingslashit( plugin_dir_path( __FILE__ ) ) );
define( 'ASTOUNDIFY_THEME_CUSTOMIZER_URL', trailingslashit( plugin_dir_url( __FILE__ ) ) );
