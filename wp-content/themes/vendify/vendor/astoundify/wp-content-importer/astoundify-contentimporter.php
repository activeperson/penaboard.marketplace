...
function astoundify_ci_php_notice() {
	...
	$notice = sprintf( __( 'Astoundify Content Importer requires at least PHP %1$s. You are running PHP %2$s. Please upgrade and try again.', 'astoundify-contentimporter' ), '<code>5.6.20</code>', '<code>' . PHP_VERSION . '</code>' );
?>

<div class="notice notice-error">
	<p><?php echo wp_kses( $notice, array( 'code' ) ); ?></p>
</div>
