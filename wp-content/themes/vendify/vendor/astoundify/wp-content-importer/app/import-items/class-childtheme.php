 ...
 * @since 1.3.0
 */
class Astoundify_CI_Import_Item_ChildTheme extends Astoundify_CI_Import_Item implements Astoundify_CI_Import_Item_Interface {
	...
	public function get_screenshot() {
		...
		$screenshot = Astoundify_CI_Utils::upload_asset( $this->item['data']['screenshot'] );
