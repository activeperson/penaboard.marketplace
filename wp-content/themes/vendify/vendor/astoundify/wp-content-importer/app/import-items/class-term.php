 ...
 * @since 1.0.0
 */
class Astoundify_CI_Import_Item_Term extends Astoundify_CI_Import_Item implements Astoundify_CI_Import_Item_Interface {
	...
	public function set_term_meta() {
		...
		if ( isset( $this->item['data']['meta'] ) ) {
			...
			$meta = apply_filters( 'astoundify_ci_term_meta', $meta );
		}
