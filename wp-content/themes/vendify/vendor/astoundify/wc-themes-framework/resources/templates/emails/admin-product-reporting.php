...
<h3><?php esc_html_e( 'Sold By:', 'astoundify-wc-themes' ); ?></h3>

<ul>
	<li><?php esc_html_e( 'Vendor: {vendor_name} (#{vendor_id})', 'astoundify-wc-themes' ); ?></li>
	<li><?php esc_html_e( 'Email: {vendor_email}', 'astoundify-wc-themes' ); ?></li>
	<li><?php esc_html_e( 'URL: {vendor_url}', 'astoundify-wc-themes' ); ?></li>
</ul>
