...
<div id="vendors-order-items" class="vendors-order-section">
	<h3><?php esc_html_e( 'Order Items', 'astoundify-wc-themes' ); ?></h3>
	...
	<table class="astoundify-wc-themes-vendors-orders-table woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
