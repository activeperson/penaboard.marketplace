...
class WC_Gateway_Liqpay extends WC_Payment_Gateway
{
    ...
    public function get_icon()
    {
        ...
        $icon_html = '<img src="//static.liqpay.ua/logo/liqpay5.png" alt="' . esc_attr__('LiqPay acceptance mark', 'woocommerce') . '" />';
